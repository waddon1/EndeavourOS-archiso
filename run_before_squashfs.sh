...
chmod +x cleaner_script.sh calamares_switcher pacstrap_calamares pacstrap_endeavouros update-mirrorlist
mv cleaner_script.sh calamares_switcher update-mirrorlist pacstrap_calamares pacstrap_endeavouros /usr/bin/
